...
pub struct Context {
    ...
    //pub time_of_alert_notification: Option<time::Instant>,
    //pub time_of_reminder_notification: Option<time::Instant>,
    //pub time_of_startup_failed_notification: Option<time::Instant>,
...
impl Context {
    pub fn new(start: time::Instant) -> Self {
        Self {
            ...
            //time_of_alert_notification: None,
            //time_of_reminder_notification: None,
            //time_of_startup_failed_notification: None,
